...
export const CellAction: React.FC<CellActionProps>= ({
    ...
    const onCopy = (id: string) => {
        ...
        toast.success("BannerId copied to clipboard") 
    }

    const onDelete = async () => {
        try {
            setLoading(true)
            await axios.delete(`/api/${params.storeId}/banners/${data.id}`) //kirim data ke folder api/stores/[storeId]/banners/[bannerId] (logic api ini ada disitu)
            router.refresh()
